      ...
      <div className="grid_about ">
        <div className="awesome " data-aos="slide-right">
          <ul className="about_article anim">
            <li>
            Hey there! I'm Peketi Pavani, passionate about web development.
            </li>
            <br />
            <li>
            I work with React, HTML, CSS, JavaScript, SQL, and MongoDB. good attention to detail and the ability to
